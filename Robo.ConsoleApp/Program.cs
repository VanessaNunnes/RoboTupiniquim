namespace Robo.ConsoleApp
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Informe a posição do robô (X): ");
            int roboX = Convert.ToInt32(Console.ReadLine());
            VerificaInput(colunas, roboX);

            Console.WriteLine("Informe a posição do robô (Y): ");
            int roboY = Convert.ToInt32(Console.ReadLine());
            VerificaInput(linhas, roboY);


            Console.WriteLine("Informe a direção do robô (N, S, L, O): ");
        ...
        {
            Console.WriteLine("Informe a área do robô (X): ");
            colunas = Convert.ToInt32(Console.ReadLine());

            Console.WriteLine("Informe a área do robô (Y): ");
        ...
        private static void VerificaInput(int colunas, int roboX)
        {
            if (roboX > colunas || roboX < 0)
            {
                while (roboX > colunas || roboX < 0)
                {
                    ...
                    Console.WriteLine($"Informe um valor menor ou igual à: {colunas}");
